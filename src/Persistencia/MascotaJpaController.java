...
public class MascotaJpaController implements Serializable {
    ...
    //Creo un constructor sin que reciba parámetros, sino que yo le diré a dónde debe apuntar, con quién relacionarse
    //Coloco el nomobre de la unidad de persistencia creada con anterioridad: Obino_Mayra_TPO2PU
    
    public MascotaJpaController() {
    emf = Persistence.createEntityManagerFactory("Obino_Mayra_tpo2PU");
    }
